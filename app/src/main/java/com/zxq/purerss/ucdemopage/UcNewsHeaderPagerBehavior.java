...
import com.zxq.purerss.BuildConfig;
...
public class UcNewsHeaderPagerBehavior extends ViewOffsetBehavior {
    ...
    private void init() {
        mOverScroller = new OverScroller(App.Companion.getInstance());
    }
...
//    }
    ...
    private int getHeaderOffsetRange() {
        return App.Companion.getInstance().getResources().getDimensionPixelOffset(R.dimen.uc_news_header_pager_offset);
    }
     ...
     * other {@link } that depend on this could not receiving the correct result of
